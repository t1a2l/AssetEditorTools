...
namespace AssetEditorTools.Utils
{
    public static class Utils
    {
        private static readonly string _fileName = "AssetEditorTools.log";
        private static readonly string _logPrefix = "AssetEditorTools: ";
        ...
        private static PluginManager.PluginInfo PluginInfo
        {
            get
            {
                ...
                throw new Exception("Failed to find AssetEditorTools assembly!");
