...
namespace AssetEditorTools.UI
{
    ...
    public static class UILabels
    {
        ...
        public static UILabel AddLabel(UIComponent parent, float xPos, float yPos, string text, float width = -1f, float textScale = 1.0f, UIHorizontalAlignment alignment = UIHorizontalAlignment.Left, string tooltip = null)
        {
            // Add label.
