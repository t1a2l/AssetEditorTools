...
namespace AssetEditorTools.UI
{
    ...
    public static class UITextures
    {
        ...
        private static readonly Dictionary<string, UITextureAtlas> FileCache = new();
        ...
        public static UITextureAtlas LoadSpriteAtlas(string fileName, string[] spriteNames)
        {
            ...
            {
                UITextureAtlas.SpriteInfo sprite = new()
                {
                    name = spriteNames[i],
                    texture = newTexture,
        ...
        private static Texture2D LoadTexture(string fileName)
        {
            ...
            {
                LogHelper.Error("exception reading texture file ", fileName);
